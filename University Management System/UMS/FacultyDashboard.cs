    ...
    public partial class FacultyDashboard : Form
    {
        ...
        private void courseList()
        {
            ...
            try
            {
                ...
                string query = "SELECT c.course_name, c.day, c.time, c.section " +
                               "FROM course c " +
                               "INNER JOIN Faculty_Course fc ON c.course_id = fc.course_id " +
                               "WHERE fc.faculty_id = '" + login_id + "' AND fc.Status = 2";

                using (SqlCommand cmd = new SqlCommand(query, uml_dbms))
                {
        ...
        // faculty result button on side bar
        ...
        // faculty registration button on side bar
        ...
        // faculty application button on side bar
        ...
        private void pictureBox1_Click(object sender, EventArgs e) // logout button
        {
        ...
        private void passCngBtn_Click(object sender, EventArgs e)
        {
            FacultyChangePass facultyChangePass = new FacultyChangePass(login_id );
            facultyChangePass.Show();
            this.Hide();
        }
    }
}
