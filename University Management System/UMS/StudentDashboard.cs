...
namespace UMS.StudentsInfo
{
    public partial class StudentDashboard : Form
    {
        ...
        public StudentDashboard(string login_id)
        {
        ...
        {
            StudentResult result = new StudentResult(login_id);
            result.Show();
            this.Hide();
        }
        ...
        {
            StudentApplication studentApplication = new StudentApplication(login_id);
         ...
         private void courseList()
        {
            ...
            try
            {
                ...
                string query = "SELECT c.course_name, c.day, c.time, c.course_id, c.section " +
                               "FROM course c " +
                               "INNER JOIN student_Course fc ON c.course_id = fc.course_id " +
                               "WHERE fc.student_id = '" + login_id + "' AND fc.Status = 2";
